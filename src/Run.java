public class Run {
    ...
    public static void main(String[] args) {
        ...
        books[0] = new ProgrammingBook("#1", "book1", 150, "author1", "java", "framework1");
        ...
        System.out.printf("the number of java books is %d",Run.getNumberofBooksInTheSameLanguage(books,"java"));
    }
}
